...
public class IRM {
	...
	private String id,	document_code,maxRole,i_no_reviewer,maxRole2,mainStatus	,sb_notes,incident_type,email_id,role_code,all_irm,active_irm,inActive_irm,project_name,department_name,location_name,	email,description	,department_code,incident_name,user_id,	project_code	,location,	ptw_code	,
	risk_type,	photo	,status,created_date,sub_code,sub_name,	created_by	,modified_by,	mdified_date,attachment,
