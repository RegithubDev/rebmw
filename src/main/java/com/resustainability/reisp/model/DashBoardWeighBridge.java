		   ...
		   ,Remarks,FIRSTWEIGHTACTUAL,TYPEOFVEHICLE ,DRIVERNAME,status ,WeightTransNo,VEHICLECAPACITY,TotalVisits,ActiveVistis,incativeVistis,customerId,id ,weight_TRNO,PTC_status ,PTCDT ,MSG,user_ip ,CONTAINERID,REMARKS,
		    	    	    	      company ,greenWB,no_of_wbR,no_of_wb2
		    	    	    	    	     ...
		    	    	    	    	     ,CustomerSAPCodeCount
		    	    	    	    	      ...
		    	    	    	    	      ,profit_center_name,
		    	    	    	    	      company_code,CustomerCode,plant_name,no_of_visits,visitsPerMonth,last_modified,TransactionNo1,TransactionNo2,Transporter,Transferstation,VehicleNo,Zone,Location,DateIN,TimeIN,DateOUT,TimeOUT,GROSSWeight,SiteID,TareWeight,NetWeight,TypeofMaterial;
